...
@Entity
@Table(name = "ERM_ONBOARDING_REQUEST_COMMENTS")
public class ErmOnboardingRequestComment {
    ...
    public Long getOnboardingRequestId() {
        return onboardingRequestId;
    }

    public void setOnboardingRequestId(Long onboardingRequestId) {
