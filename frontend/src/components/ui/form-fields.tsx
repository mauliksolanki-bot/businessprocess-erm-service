  ...
  return (
    <div className={cn("relative", wrapperClassName)}>
      <textarea
        {...props}
        className={cn(
          "h-28 w-full rounded-xl border border-zinc-300 bg-white px-3 pb-2 pt-5 text-sm text-zinc-900 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50 placeholder:text-transparent",
          className
        )}
        onBlur={(event) => {
          setIsFocused(false);
  ...
  return (
    <label className={cn("relative block", wrapperClassName)}>
      ...
      <select
        {...props}
        className={cn(
          "h-11 w-full rounded-xl border border-zinc-300 bg-white px-3 pb-1 pt-4 text-sm text-zinc-900 outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:bg-zinc-100 disabled:text-zinc-500",
          className
        )}
      >
        {children}
